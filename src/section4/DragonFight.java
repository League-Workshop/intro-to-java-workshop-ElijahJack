...
public class DragonFight {
	...
	public static void main(String[] args) {
		...
		int dragonDamage = rand.nextInt(10);
		...
		while (playerHealth > 0 && dragonHealth > 0) { // this line of code keeps the battle going until someone's
			...
			// or a kick
			String attack = JOptionPane.showInputDialog("Attack the dragon with a yell or a kick? Dragon Health:"+ dragonHealth + " Player Health:"+ playerHealth);
